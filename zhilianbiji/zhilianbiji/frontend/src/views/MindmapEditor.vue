    ...
    >
      <div>
        ...
        <el-table :data="shareLinks" style="width: 100%;">
          <el-table-column prop="token" label="分享链接" min-width="250">
            <template #default="scope">
              <div style="display: flex; align-items: center; gap: 8px;">
                <a :href="getFullShareUrl('/shared/mindmap/' + scope.row.token)" target="_blank" style="flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ getFullShareUrl('/shared/mindmap/' + scope.row.token) }}</a>
                <el-button size="small" @click="copyShareLink('/shared/mindmap/' + scope.row.token)">
